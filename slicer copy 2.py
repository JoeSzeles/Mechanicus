...
def writeGcode(slices,output_filename):

    extrudeRate = 0.05
    f = open(output_filename[:-3] + "gcode",'w')
...
def main():
    ...
    infillPercent = 1  # between 0 and 1
    ...
    output_filename = "output6.ode"
    writeGcode(slices, output_filename)
