    ...
    if contours:
        ...
        if moments["m00"] != 0:
            ...
            if target_x is not None and target_y is not None:
                ...
                new_x = target_x  # Adjust as needed
                new_y = target_y  # Adjust as needed

                # Calculate the distance to the new position
                diff_x = new_x - current_x  # Calculate the difference in X
                diff_y = new_y - current_y  # Calculate the difference in Y
