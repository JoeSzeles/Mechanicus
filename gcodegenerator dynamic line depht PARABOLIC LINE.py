...
def calculate_parabolic_path(start, end, z_draw_value, material_height_value):
    ...
    for t in range(0, 101):  # You can adjust the number of points for the parabola
        ...
        x = (1 - t_normalized) * ((1 - t_normalized) * start[0] + t_normalized * x_c) + t_normalized * (
                    (1 - t_normalized) * x_c + t_normalized * end[0])
        y = (1 - t_normalized) * ((1 - t_normalized) * start[1] + t_normalized * y_c) + t_normalized * (
                    (1 - t_normalized) * y_c + t_normalized * end[1])
        z = (1 - t_normalized) * ((1 - t_normalized) * material_height_value + t_normalized * z_draw_value) + t_normalized * (
                    (1 - t_normalized) * z_draw_value + t_normalized * material_height_value)
