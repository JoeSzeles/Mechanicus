...
def optimise_path(shapes):
    ...
    # For example, you can use the nearest-neighbor algorithm:
    from gcodegenerator import nearest_neighbor
    optimized_path = []
    for shape in shapes:
...
def shapes_2_gcode(shapes, z_start, z_center, z_end, draw_speed, gradient_length_mm):
    t1 = dt.now()
