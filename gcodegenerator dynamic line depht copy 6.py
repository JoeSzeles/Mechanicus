...
# Example usage of the dynamic stroke generation function
start_point = (10, 10)
end_point = (90, 90)
dynamic_strokes = generate_dynamic_strokes(start_point, end_point, depth=2, width=1, num_points=10)
print("Dynamic Strokes:", dynamic_strokes)

# Example usage of the generate_gcode function
svg_file = "test9.svg"
gcode_file = "test_8.gcode"
z_start = 19
z_center = 10
z_end = 19
gradient_length_mm = 20
generate_gcode(svg_file, gcode_file, z_start, z_center, z_end, gradient_length_mm)
