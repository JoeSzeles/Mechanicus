...
def generate_mosaic():
    ...
    # Generate the points for the Doppler spiral
    t_values = np.linspace(0, a * np.pi, n_points)  # Adjust the range of t as needed
    x_values = np.cos(t_values) * np.cos(2 * t_values)
    y_values = np.sin(t_values) * np.cos(2 * t_values)
