...
# Function to generate Ulam spiral points
def ulam_spiral_points(n_points):
    x = [0]
    y = [0]
    dx = [0, 1, 0, -1]
    dy = [1, 0, -1, 0]
    ...
    steps = a       # Number of steps in the current direction
    step_count = 0  # Number of steps taken in the current direction
...
def generate_mosaic():
    ...
    # Generate Ulam spiral points
    x_values, y_values = ulam_spiral_points(n_points)
